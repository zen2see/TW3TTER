...
interface BridgeFacetInterface extends ethers.utils.Interface {
  functions: {
    ...
    "withdrawPostGetBatch(uint256[])": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "withdrawPostGetBatch",
    values: [BigNumberish[]]
  ): string;
  ...
  events: {
    ...
    "AddedPostGetBatch(address,uint256[])": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "AddedPostGetBatch"): EventFragment;
...
export type AddedPostGetBatchEvent = TypedEvent<
...
export class BridgeFacet extends BaseContract {
  ...
  filters: {
    ...
    "AddedPostGetBatch(address,uint256[])"(
      owner?: string | null,
      tokenIds?: null
    ): TypedEventFilter<
      [string, BigNumber[]],
