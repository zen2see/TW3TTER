...
interface ERC721MarketplaceFacetInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getOwnerPostGetListings(address,uint256,string,uint256)": FunctionFragment;
    "getPostGetListing(uint256)": FunctionFragment;
    "getPostGetListings(uint256,string,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getOwnerPostGetListings",
    values: [string, BigNumberish, string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "getPostGetListing",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "getPostGetListings",
    values: [BigNumberish, string, BigNumberish]
  ): string;
  encodeFunctionData(
