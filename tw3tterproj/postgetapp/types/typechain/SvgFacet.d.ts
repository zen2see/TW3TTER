...
interface SvgFacetInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getPostGetSvg(uint256)": FunctionFragment;
    "getSvg(bytes32,uint256)": FunctionFragment;
    "getSvgs(bytes32,uint256[])": FunctionFragment;
    "portalPostGetsSvg(uint256)": FunctionFragment;
    "previewPostGet(uint256,address,int16[6],uint16[16])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getPostGetSvg",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "portalPostGetsSvg",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "previewPostGet",
    values: [
      BigNumberish,
      string,
      [
