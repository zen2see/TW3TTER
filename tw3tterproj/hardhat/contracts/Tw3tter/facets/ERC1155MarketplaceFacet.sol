...
contract ERC1155MarketplaceFacet is Modifiers {
    ...
    ///@notice Allow the postget diamond owner or DAO to set the default listing fee
    ...
    ///@notice Allow the postget diamond owner or DAO to set the category details for multiple ERC1155 NFTs
    ...
    ///@param _priceInWei The cost price of the NFT individually in $POGT
    function setERC1155Listing(
        ...
        require(cost >= 1e18, "ERC1155Marketplace: cost should be 1 POGT or larger");
        ...
        if (s.listingFeeInWei > 0) {
            ...
            LibERC20.transferFrom(s.pogtContract, LibMeta.msgSender(), address(0xFFfFfFffFFfffFFfFFfFFFFFffFFFffffFfFFFfF), s.listingFeeInWei);
        }
    }
    ...
    function executeERC1155Listing(
        ...
        listing.quantity -= _quantity;
        uint256 cost = _quantity * _priceInWei;
        require(IERC20(s.pogtContract).balanceOf(buyer) >= cost, "ERC1155Marketplace: not enough POGT");
        {
