...
import {Modifiers, EQUIPPED_WEARABLE_SLOTS, PostGet} from "../libraries/LibAppStorage.sol";
...
contract ItemsTransferFacet is Modifiers {
    ...
    */
    ...
    function transferFromTokenApproved(
        ...
        if (_fromContract == address(this)) {
            address owner = s.postgets[_fromTokenId].owner;
            require(
            ...
            require(s.postgets[_fromTokenId].locked == false, "ItemsTransfer: Only callable on unlocked PostGets");
        } else {
    ...
    */
    ...
    ///@notice Used to extract items that have been accidentally burned with PostGets
    function extractItemsFromSacrificedGotchi(
        ...
        require(postget.owner == address(0), "PostGet has not been sacrificed");
